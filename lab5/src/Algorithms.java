...
public class Algorithms {
    ...
    public ArrayList simulate(ArrayList<Process> processes, ArrayList<Processor> processors, int variant) {
        inquiries = 0;
        migrations = 0;
        int counter = 0;
        double sum = 0;
        ...
        retList.add(sum/counter);
        retList.add(sumDevitation/deviation.size());
        retList.add(inquiries);
        retList.add(migrations);
        return retList;
    }
